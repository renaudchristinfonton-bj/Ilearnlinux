...
LEVELS = [
    L(1, "Premier contact",
      ...
      mission="Dans ton onglet JOUEUR (pense d'abord a activer le hook avec la commande 'source .../hook.sh' si ce n'est pas fait), "
              "tape :  echo je-suis-pret",
      checks=[C_cmd(r"\becho\b.*je-suis-pret")],
      hints=["Va dans l'onglet JOUEUR, pas dans celui du jeu.",
    ...
    L(2, "Ou suis-je ? (pwd)",
      ...
      mission="Dans l'onglet JOUEUR, tape :  pwd",
    ...
    L(3, "Qui suis-je ? (whoami)",
      ...
      mission="Dans l'onglet JOUEUR, tape :  whoami",
    ...
    L(4, "Echo, l'ami fidele",
      ...
      mission="Affiche la phrase 'linux-cest-cool' avec echo.",
    ...
    L(9, "Ecrire dans un fichier (>)",
      ...
      mission="Dans l'arene du niveau, cree un fichier bonjour.txt contenant le mot 'salut' avec :  echo salut > bonjour.txt",
      checks=[C_fe("bonjour.txt"), C_fc("bonjour.txt", text="salut")],
      hints=["Pense a aller dans l'arene avec 'cd' (le jeu affiche le chemin).",
    ...
    L(10, "BOSS du jour : carte d'identite",
      ...
      mission="Dans l'arene, cree un fichier moi.txt contenant ton prenom (ou pseudo), en UNE commande echo avec redirection.",
